...
engineered **18 detection-as-code rules with unit tests**, emulated a financially-motivated intrusion end-to-end, ran
...
Each of the 18 Sigma rules ships with unit tests asserting it (a) fires on malicious input and (b) stays silent on a
